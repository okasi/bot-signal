...
const CHECKS = [
  ...
  ["isIframeInconsistent", "Shared realm objects, webdriver drift, or two or more Navigator values differ in a fresh iframe", "bad"],
  ...
  ["isCanvasTampered", "A deterministic canvas pixel moved beyond display-pipeline tolerance on readback", "bad"],
  ...
  ["isWorkerInconsistent", "Two or more worker Navigator values differ from the main realm (async run)", "async-bad"],
